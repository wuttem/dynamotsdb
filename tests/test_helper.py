...
class HelperTest(unittest.TestCase):
    ...
    def test_trim(self):
        from pytsdb.helper import trim_timetuple
        t = time.time()
    ...
    def test_findrightsplits(self):
        # right hourly
        from pytsdb.helper import ts_hourly_right
        t = time.time()
        t = ts_hourly_right(t)
        ...
        # right daily
        from pytsdb.helper import ts_daily_right
        t = time.time()
        t = ts_daily_right(t)
        ...
        # Left weekly
        from pytsdb.helper import ts_weekly_right
        t = 1470388856.652508
        t = ts_weekly_right(t)
        ...
        # Left monthly
        from pytsdb.helper import ts_monthly_right
        t = 1470388856.652508
