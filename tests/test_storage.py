...
class StorageTest(unittest.TestCase):
    ...
    def test_cassandrastore(self):
        ...
        l._createTable()
        self.assertTrue(l)
        l._insert(key="test.ph", range_key=1000, data=b"bar1")
        l._insert(key="test.ph", range_key=2000, data=b"bar4")
        l._insert(key="test.ph", range_key=1100, data=b"bar2")
        l._insert(key="test.ph", range_key=1200, data=b"bar3")
